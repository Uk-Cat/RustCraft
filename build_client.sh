...
cp ./target/x86_64-pc-windows-gnu/release/rustcraft.exe ./target/rustcraft_x86_64_windows.exe || { echo "Error copying Windows client"; exit 1; }
cp ./target/release/rustcraft ./target/rustcraft_x86_64_linux || { echo "Error copying Linux client"; exit 1; }
